...
//	    if (loginMember == null) {
//	        redirect(req, res, "/member?action=loginForm");
//	        return;
//	    }
//	    ChallengeDto challenge = buildChallengeFromRequest(req);
//	    challenge.setCreatorId(loginMember.getId());  // ← 생성자 ID 저장
...
//
//	    // 소유권 확인
//	    if (loginMember == null || challenge == null
//	            || !challenge.getCreatorId().equals(loginMember.getId())) {
//	        req.getSession().setAttribute("alertMsg", "삭제 권한이 없습니다.");
//	        redirect(req, res, "/challenge?action=list");
//	        return;
//	    }
